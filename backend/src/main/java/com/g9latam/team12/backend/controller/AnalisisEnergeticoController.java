...
@CrossOrigin(origins = {"http://localhost", "http://127.0.0.1:5500", "https://github.io"})@Tag(name = "Análisis Energético", description = "Endpoints para la evaluación de consumo eléctrico y predicción de eficiencia")
